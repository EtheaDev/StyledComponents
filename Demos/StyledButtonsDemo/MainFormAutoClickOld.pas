...
procedure TAutoClickMain.AutoClick(Sender: TObject);
var
  LCaption: string;
begin
...
procedure TAutoClickMain.FormCreate(Sender: TObject);
begin
...
procedure TAutoClickMain.StartAutoClick;
begin
...
procedure TAutoClickMain.StartStyledButtonClick(Sender: TObject);
begin
  StartAutoClick;
end;

procedure TAutoClickMain.TestDialogsStyledButtonClick(Sender: TObject);
var
  LMessage: string;
var
